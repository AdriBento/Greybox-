...
from utils import make_x_y_data_pascal_proportion
import numpy as np
import pickle
...
#Parse data
train_images_path, train_x, train_y = make_x_y_data_pascal_proportion(train_path, shuffled=True)
val_images_path, val_x, val_y = make_x_y_data_pascal_proportion(val_path, shuffled=True)
test_images_path, test_x, test_y = make_x_y_data_pascal_proportion(test_path)
