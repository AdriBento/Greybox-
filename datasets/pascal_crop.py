...
class PascalResized(data.Dataset):
    """Pascal  Dataset.
    ...
    **Parameters:**
    ...
    def __init__(self, root, split='train', mode='fine', target_type='semantic', transform=None):
        ...
        self.images_dir = os.path.join("/home/abennetot/dataset/Pascal10/pascalpart/Deeplab_resize/Images", split)
        ...
        for style in os.listdir(self.images_dir):
            ...
            for file_name in os.listdir(img_dir):
                ...
                target_name = file_name[:-4] + '23_attrib_5px_resized_masked.png'
