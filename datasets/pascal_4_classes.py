...
class Pascal4class(data.Dataset):
    """Pascal  Dataset.
    ...
    **Parameters:**
    ...
    def __init__(self, root, split='train', mode='fine', target_type='semantic', transform=None):
        ...
        self.images_dir = os.path.join("/home/abennetot/dataset/Pascal10/pascalpart/Deeplab_4_classes/Images", split)

        self.targets_dir = os.path.join("/home/abennetot/dataset/Pascal10/pascalpart/Deeplab_4_classes_masked/Images", split)
        ...
        for style in os.listdir(self.images_dir):
            ...
            for file_name in os.listdir(img_dir):
                ...
                target_name = file_name[:-4] + '4_classes.png'
    ...
    def __getitem__(self, index):
        ...
        if 'Aeroplane' in self.images[index]:
            target_class = 0
